...
/**
 * <p>@filename MyBloomFilter</p>
 * <p>
 * <p>@description 自己实现布隆过滤器</p>
 *
 * 摘自https://github.com/MagnusS/Java-BloomFilter
 *
 * @author liyupeng
 * @version 1.0
...
public class MyBloomFilter<E> implements Serializable{
     ...
     */
    public MyBloomFilter(double c, int n, int k) {
     ...
     */
    public MyBloomFilter(int bitSetSize, int expectedNumberOElements) {
     ...
     */
    public MyBloomFilter(double falsePositiveProbability, int expectedNumberOfElements) {
     ...
     */
    public MyBloomFilter(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, BitSet filterData) {
    ...
    public boolean equals(Object obj) {
        ...
        final MyBloomFilter<E> other = (MyBloomFilter<E>) obj;
